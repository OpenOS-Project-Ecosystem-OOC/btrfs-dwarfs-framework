...
The `integrations/` directory contains three projects that extend or consume btrfs-dwarfs-framework, merged as read-tree snapshots. Each can be updated independently by fetching from its upstream remote and re-running `git read-tree`.
